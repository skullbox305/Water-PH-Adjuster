...
SOURCEFILES := i2c_iO.cpp globalMtx.cpp HabitatConfiguration.cpp main.cpp phAdjuster.cpp phControl.cpp phSensor.cpp sensorReader.cpp
EXTERNAL_LIBS := 
